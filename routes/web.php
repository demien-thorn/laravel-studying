...
Route::middleware(['middleware' => 'set_locale'])->group(callback: function () {
    ...
    Route::middleware(['auth'])->group(callback: function () {
        Route::group(attributes: ['prefix' => 'person/orders', 'as' => 'person.'], routes: function () {
        ...
        Route::group(attributes: ['prefix' => 'admin'], routes: function () {
            Route::group(attributes: ['middleware' => 'is_admin', 'prefix' => 'orders'], routes: function () {
    ...
    Route::group(attributes: ['prefix' => 'basket'], routes: function () {
        Route::post(uri: '/add/{skus}', action: [BasketC::class, 'basketAdd'])->name(name: 'basket-add');

        Route::group(attributes: ['middleware' => 'basket_not_empty'], routes: function () {
